(function($,window){
  $.fn.textWidth=function(){
    ...
    var chars=Array.prototype.slice.call(arguments);for(var i=chars.length;i-->0;){
      var n=chars[i]-65536;if(n>=0){
        chars.splice(i,1,55296+(n>>10),56320+(n&1023));
      }
    ...
    this.setValue(this.getValue()-this.settings.step_size);
  };$.fn.rate.settings={max_value:5,step_size:.5,initial_value:0,symbols:{utf8_star:{base:'☆',hover:'★',selected:'★'},utf8_hexagon:{base:'⬡',hover:'⬢',selected:'⬢'},hearts:'&hearts;',fontawesome_beer:'<i class="fas fa-beer"></i>',fontawesome_star:{base:'<i class="far fa-star"></i>',hover:'<i class="fas fa-star"></i>',selected:'<i class="fas fa-star"></i>'},utf8_emoticons:{base:[128549,128531,128530,128516],hover:[128549,128531,128530,128516],selected:[128549,128531,128530,128516]}},selected_symbol_type:'utf8_star',convert_to_utf8:false,cursor:'default',readonly:false,change_once:false,only_select_one_symbol:false,ajax_method:'POST',additional_data:{}};
})(jQuery,window);
